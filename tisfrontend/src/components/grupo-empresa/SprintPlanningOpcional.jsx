...
const TaskColumn = ({ title, status, tasks, onDrop, onDragOver, onStatusChange }) => (
...
const SprintPlanning = () => {
    ...
    const renderTasksByStatusForStory = (storyTitle, status) => {
        return tasks.filter(task => task.historia_usuario.titulo === storyTitle && task.estado === status);
    };
